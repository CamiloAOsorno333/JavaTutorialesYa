package Lecciones.EstructurasDinamicas.Listas;
...
Listas tipo cola.
Listas genéricas.
Una lista se comporta como una pila si las inserciones y extracciones las hacemos por un mismo lado de la lista.
...
de la lista.
También se las llama listas FIFO (First In First Out - primero en entrar primero en salir)
